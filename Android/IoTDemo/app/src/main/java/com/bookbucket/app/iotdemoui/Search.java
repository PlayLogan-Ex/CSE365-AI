...
public class Search extends AppCompatActivity {
    ...
    private AdapterData questionAdpater;
    ...
    private class AsyncFetch extends AsyncTask<String, String, String> {
        ...
        protected String doInBackground(String... params) {
            try {
//                url = new URL("http://bcszone.com/iot/search/data-search.php");
                url = new URL("http://192.168.0.100/IoT/PHP/controllers/RetrieveQuestionList.php");
            ...
            if(result.equals("no rows")) {
                ...
                try {
                    ...
                    for (int i = 0; i < jsonArray.length(); i++) {
                        ...
                        question.questionHolder = jsonData.getString("questionHolder");
                        question.questionID = jsonData.getInt("questionID");
                        question.questionText = jsonData.getString("questionText");
                        question.tag = jsonData.getString("tag");
                    ...
                    questionAdpater = new AdapterData(Search.this, data);
                    recyclerViewQuestion.setAdapter(questionAdpater);
                    recyclerViewQuestion.setLayoutManager(new LinearLayoutManager(Search.this));
